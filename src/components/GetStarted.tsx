...
const GetStarted = () => {
  return (
    <>
      <button className="bg-[#03FFFE] md:max-w-[190px] md:h-[41px] text-black max-w-[47.38px] h-[10.22px] md:rounded-md rounded-sm flex flex-col justify-center items-center">
