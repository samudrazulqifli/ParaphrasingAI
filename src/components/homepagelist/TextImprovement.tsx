  ...
  return (
    <>
      ...
      <div className="bg-white md:h-[271px] h-[67.62px] md:w-[327px] w-[81.59px] md:rounded-xl rounded-sm absolute md:right-12 md:bottom-12 right-3 bottom-3 md:p-4 p-1 md:text-[12px] text-[2.99px] font-semibold">
        ...
        <div className="md:w-[277px] w-[69.12px] md:h-[33px] h-[8.23px] border border-[#047AC0] md:rounded rounded-sm mx-auto grid content-center md:mt-3 mt-[3px]">
          <div className="md:text-[12px] text-[2.99px] font-bold text-[#047AC0] mx-auto">Rewrite</div>
        </div>
      </div>
    </>
  );
