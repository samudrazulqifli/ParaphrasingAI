  ...
  return (
    <>
      ...
      <div className="bg-white md:h-[271px] h-[67.62px] md:w-[327px] w-[81.59px] md:rounded-xl rounded-sm absolute md:right-12 md:bottom-12 right-3 bottom-3 md:p-4 p-1 md:text-[12px] text-[2.99px] font-semibold">
        ...
        <div className="md:border border-[0.25px] border-black md:rounded-lg rounded-sm md:w-[296px] w-[73.86px] md:h-[169px] h-[42.17px] md:mt-1 mt-[1px] md:pt-4 flex flex-col">
        ...
        <div className="md:w-[121px] w-[30.19px] md:h-[33px] h-[8.23px] border border-[#047AC0] md:rounded rounded-sm mx-auto grid content-center md:mt-3 mt-[2px]">
          <img
