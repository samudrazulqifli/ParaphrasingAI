  ...
  return (
    <>
      <div className="bg-white md:h-[192px] h-[47.91px] md:w-[327px] w-[81.59px] md:rounded-xl rounded-sm absolute md:left-10 md:top-12 top-2 left-2 md:p-4 p-1 text-black">
        <div className="flex justify-between content-end md:text-[12px] text-[2.99px] font-semibold">
          <div className="">Your Text</div>
          <div className="flex items-center md:gap-x-1 gap-x-[1.5px]">
        ...
        <div className="md:border-2 border-[0.25px] border-black md:rounded-lg rounded-sm md:w-[296px] w-[73.86px] md:h-[140px] h-[34.93px] md:mt-1 mt-[1px] md:pt-4 flex flex-col">
      ...
      <div className="bg-white md:h-[271px] h-[67.62px] md:w-[327px] w-[81.59px] md:rounded-xl rounded-sm absolute md:right-12 md:bottom-12 right-3 bottom-3 md:p-4 p-1 md:text-[12px] text-[2.99px] font-semibold">
        ...
        <div className="md:border-2 border-[0.01px] border-black md:rounded-lg rounded-sm md:w-[296px] w-[73.86px] md:h-[169px] h-[42.17px] md:mt-1 mt-[1px] md:pt-4 flex flex-col">
        ...
        <div className="flex justify-between md:mt-3 mt-[1px]">
          ...
          <div className="md:h-[37px] h-[9.15px] md:w-[82px] w-[20.28px] md:border-2 border-[0.25px] border-black md:rounded-md rounded-sm grid content-center">
            <img
